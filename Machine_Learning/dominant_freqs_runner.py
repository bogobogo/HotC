import dominanat_freqs_learner
import consts
import os
import sys
import argparse
...
def parse_args(args):
	...
	parser.add_argument('-e' type=int, required=True, metarvar='epochs', help=EPOCHS_HELP)
	...
	parser.add_argument('-g', action='store_true', metavar='Graph', help='Display error graph')
	parser.add_argument('-v', action='store_true', metavar='Verbose', help='Verbose output')
